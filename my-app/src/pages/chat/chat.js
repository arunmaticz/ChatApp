...
const Chat = () => {
    ...
    const sendMessage = (e) => {
        ...
        // }, 100)
        axios.post('http://localhost:8000/msg',{message:message,user:user,receiver:to}).then(result=>{
        ...
        socket.emit('private_chat', {
            ...
            message:message,
            to:to
        }, console.log("emit prvchcat"),() => setMessage(""))
    }
    ...
    useEffect(()=>{
        socket.on('receiver1',msg => {
            console.log("sdfdsfdsgfdg")
            console.log("inside reciver ;",msg);
            setMessages((prevMsg) => ([...prevMsg, msg]))
                    ...
                    <div className="panel panel-default">
                        ...
                        <div className="panel-footer">
                            <div className="input-group">
                                <input onChange={(e)=> setTo(e.target.value)} placeholder="To.."/>
                                ...
                                <input id="btn-input" type="text"
                                    ...
                                    <input type="button" onClick={()=> sendMessage(message)} value="send"/>
